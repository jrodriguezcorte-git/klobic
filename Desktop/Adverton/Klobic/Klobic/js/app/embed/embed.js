...
/*    img.src = "/images/logo.png";
    ...
    if(documentHeight <= 90)
        img.style.height = '70%';
    else
        img.style.height = '30%';
 */       
    var div = document.createElement('div');
    div.setAttribute('class', 'wraptocenter');
//    div.appendChild(img);
...
//    document.getElementById('bs').appendChild(div);
    ...
    //     'background-size: cover; height: 19px;}' +
...
BannerDisplay.prototype._addClickWatermarkListener = function(el) {
    ...
    el.addEventListener('click', function(ev) {
        var wmLink = '//www.klobic.com/?utm_source=freebanner&utm_medium=watermark1&utm_content=' +
            self.properties.width + 'x' + self.properties.height;
...
EmbedCanvas.prototype.init = function(bannerContainer, data, config) {
    ...
    if ((!data.paid || data.paid == 0) && !config.printScreen) {
